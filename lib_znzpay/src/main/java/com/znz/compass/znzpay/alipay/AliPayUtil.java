...
public class AliPayUtil {
                ...
                case SDK_PAY_FLAG: {
                    ...
                    switch (resultStatus) {
                        case "9000":
                            ...
                            if (onAliPayResultLintener != null) {
                                onAliPayResultLintener.onPayResult("支付成功");
                            }
                            break;
                        case "8000":
                        ...
                        case "6001":
                            ...
                            if (onAliPayResultLintener != null) {
                                onAliPayResultLintener.onPayResult("支付取消");
                            }
                            break;
                        default:
                            Toast.makeText(activity, "支付失败", Toast.LENGTH_LONG).show();
                            if (onAliPayResultLintener != null) {
                                onAliPayResultLintener.onPayResult("支付失败");
                            }
                            break;
                    }
                    break;
     ...
     */
    public void startAliPay(String orderNO, OnAliPayResultLintener onAliPayResultLintener) {
